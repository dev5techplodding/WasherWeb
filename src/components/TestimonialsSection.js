...
const TESTIMONIALS = [
  {
    ...
    location: 'Toronto, ON',
    rating: 5,
    quote: 'I\'ve tried every laundry service in the city. Washr is the only one that actually delivers commercial-grade quality. My dry cleaning comes back flawless — every single time.',
    avatarColor: '#1B3A5C',
    featured: true,
  ...
  },
  {
    ...
    rating: 5,
    quote: 'As someone who works 12-hour days, Washr gave me back my weekends. The pickup and delivery is seamless — I literally set a schedule and forget about laundry entirely.',
    avatarColor: '#2A5580',
  ...
  },
  {
    ...
    location: 'Calgary, AB',
    rating: 5,
    quote: 'The hypoallergenic detergent option is a game-changer for my family. My daughter has sensitive skin and Washr is the first service that actually accommodates that without upcharging.',
    avatarColor: '#F28C28',
  ...
  },
  {
    ...
    rating: 5,
    quote: 'We use Washr for all our restaurant linens and staff uniforms. The quality is consistently perfect and the turnaround time is unmatched. It\'s become essential to our operation.',
    avatarColor: '#1B3A5C',
  ...
  },
  {
    ...
    location: 'Ottawa, ON',
    rating: 5,
    quote: 'First impressions matter in my line of work. Washr keeps my wardrobe looking impeccable. Transparent pricing means no surprises — just expert care at a fair price.',
    avatarColor: '#2A5580',
  ...
  },
  {
    ...
    rating: 5,
    quote: 'The real-time tracking is brilliant. I can see exactly where my garments are in the process. It\'s the kind of transparency you\'d expect from a premium service — and Washr delivers.',
    avatarColor: '#F28C28',
