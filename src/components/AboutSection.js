    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div ref={headingRef} className="max-w-3xl mb-14 md:mb-20">
          <span
            className="animate-in inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.18em] mb-5 px-4 py-1.5 rounded-full"
            style={{
          ...
          >
            Washr connects you with vetted, commercial-grade laundry facilities — not residential gig workers.
